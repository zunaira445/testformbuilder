...
.popular-ribbon {
    ...
    padding: .3rem .9rem; border-bottom-left-radius: 12px;
...
.price-box {
    background: var(--bs-secondary-bg); border-radius: 12px;
    padding: .6rem .9rem; flex: 1; text-align: center;
...
.feature-item {
    ...
    gap: .6rem; padding: .35rem 0; font-size: .875rem;
}
...
/* ─── CTA ────────────────────────────────────────────── */
.plan-cta { padding: 0 1.75rem 1.75rem; display: grid; }
.btn-plan {
...
.current-plan-badge {
    ...
    text-align: center; font-size: .75rem; font-weight: 700; padding: .3rem;
}
...
.copy-badge {
    font-size: .7rem; padding: .15rem .5rem; border-radius: 4px; cursor: pointer;
    background: var(--bs-secondary-bg); border: 1px solid var(--bs-border-color); transition: all .15s;
}
.copy-badge:hover { background: #1e40af; color: #fff; border-color: #1e40af; }

/* ─── UPLOAD ZONE ────────────────────────────────────── */
.upload-zone {
    border: 2.5px dashed var(--bs-border-color); border-radius: 14px;
    padding: 2rem; text-align: center; transition: all .2s;
    cursor: pointer; background: var(--bs-secondary-bg);
}
.upload-zone:hover, .upload-zone.dragging { border-color: #3b82f6; background: rgba(59,130,246,.05); }
.upload-zone i { font-size: 2.5rem; color: var(--bs-secondary-color); }
.upload-preview img { max-height: 200px; border-radius: 10px; box-shadow: 0 4px 16px rgba(0,0,0,.1); }
...
<div class="row g-4 justify-content-center mb-5 align-items-stretch">
    ...
    <div class="col-md-4 col-lg-3">
        <div class="plan-card h-100 shadow-sm {{ $sub?->plan?->name === 'Basic' ? 'border-success' : '' }}">
            ...
            <div class="plan-cta">
                <button class="btn btn-plan btn-outline-secondary"
                        onclick="openPaymentForm('Basic', 2000, 'monthly')">
                    Get Basic
                </button>
            </div>
        </div>
    ...
    {{-- PRO — UPDATED: 20 tests, 250 students, PDF only (no Excel) --}}
    <div class="col-md-4 col-lg-3">
        <div class="plan-card popular h-100 shadow {{ $sub?->plan?->name === 'Pro' ? 'border-success' : '' }}">
            ...
            <div class="plan-cta">
                <button class="btn btn-plan btn-primary"
                        onclick="openPaymentForm('Pro', 3500, 'monthly')">
    ...
    {{-- MAX — UPDATED: API Access removed, Anti-Cheating Feature added --}}
    <div class="col-md-4 col-lg-3">
        <div class="plan-card h-100 shadow-sm {{ $sub?->plan?->name === 'Max' ? 'border-success' : '' }}"
             style="border-color:#7c3aed">
            @if($sub?->plan?->name === 'Max')<div class="current-plan-badge">✓ Current Plan</div>@endif
            <div class="plan-header">
                <div class="plan-icon" style="background:rgba(124,58,237,.12);color:#7c3aed">
            ...
            <div class="plan-pricing">
                <div class="billing-toggle-wrap">
                    <div class="price-box active" id="maxMonthly" onclick="selectBilling('max','monthly')"
                         style="border-color:#7c3aed;background:rgba(124,58,237,.06)">
            ...
            <div class="plan-features">
                @foreach([
                    ...
                    [true, 'Advanced Anti-Cheating System'],
            ...
            <div class="plan-cta">
                <button class="btn btn-plan fw-bold"
                        style="background:linear-gradient(135deg,#7c3aed,#5b21b6);color:#fff"
                        onclick="openPaymentForm('Max', 7000, 'monthly')">
...
<div class="mb-5">
    <div class="text-center mb-4">
        ...
        <p class="text-muted small">Send payment to any of the following accounts, then upload your proof below.</p>
    </div>
    <div class="row g-3 justify-content-center">
        ...
        <div class="col-md-4">
            <div class="payment-method-card h-100">
                ...
                <div class="flex-grow-1">
                    <div class="fw-bold mb-1">JazzCash</div>
        ...
        <div class="col-md-4">
            <div class="payment-method-card h-100">
                ...
                <div class="flex-grow-1">
                    <div class="fw-bold mb-1">EasyPaisa</div>
                    <div class="payment-detail-label">Account Title</div>
                    <div class="payment-detail-val">Nisar Ahmed</div>
                    <div class="mt-1 d-flex align-items-center gap-2">
                        <div>
        ...
        <div class="col-md-4">
            <div class="payment-method-card h-100">
                ...
                <div class="flex-grow-1">
                    <div class="fw-bold mb-1">Binance Pay</div>
                    <div class="payment-detail-label">Account Title</div>
            ...
            <div class="card-body p-4">
                ...
                <div class="alert alert-success d-flex align-items-center gap-2" style="border-radius:12px">
                    ...
                    <div>
                        ...
                        <small>Our team will verify and activate your plan within 2–12 hours.
                        You will receive a confirmation email once approved.</small>
                    </div>
                </div>
                @endif
                ...
                <form method="POST"
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <div id="selectedPlanBadge" class="selected-plan-badge">
                                <i class="bi bi-gem me-2"></i>
                                <span id="selectedPlanName">No plan selected</span>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="method" id="methodSelect" class="form-select" required
                                    onchange="updatePaymentHint(this.value)">
                        ...
                        {{-- Amount Preview --}}
                        <div class="col-12" id="amountPreviewWrap" style="display:none">
                            <div class="alert alert-primary py-2 px-3 d-flex justify-content-between align-items-center mb-0"
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="transaction_id" class="form-control"
                                       ...
                                       placeholder="e.g. TXN-20241231-00012345" required>
                            </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="notes" class="form-control" rows="2"
                                      placeholder="Any special instructions for the admin...">{{ old('notes') }}</textarea>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <p class="text-center text-muted small mt-2 mb-0">
                                ...
                                Your payment will be verified within 2–12 hours.
...
<div class="text-center py-4 border-top mt-2">
    ...
    <a href="https://wa.me/923148379859?text=Hi, I want to know about SWF Portal subscription plans"
       target="_blank" class="btn btn-success fw-semibold px-4 me-2">
...
/* ─── Plan data (name → DB id mapping done by dropdown) ── */
const billingPrices = {
...
function selectBilling(plan, period) {
    const mBox = document.getElementById(plan + 'Monthly');
    const yBox = document.getElementById(plan + 'Yearly');
    if (!mBox || !yBox) return;
    mBox.classList.toggle('active', period === 'monthly');
    yBox.classList.toggle('active', period === 'yearly');

    const price    = billingPrices[plan]?.[period] ?? 0;
    const planName = plan.charAt(0).toUpperCase() + plan.slice(1);
    // Update the get-button onclick dynamically
    const btn = document.querySelector(`button[data-plan="${planName}"]`);
    if (btn) btn.setAttribute('onclick', `openPaymentForm('${planName}', ${price}, '${period}')`);
}

/* ─── KEY FIX: Open Payment Form + Auto-Select Plan ──────── */
function openPaymentForm(planName, price, period) {
    // 1. Scroll to form
    const section = document.getElementById('paymentFormSection');
    if (section) section.scrollIntoView({ behavior: 'smooth', block: 'start' });

    // 2. Auto-select matching option in dropdown
    const sel = document.getElementById('planSelect');
    if (sel) {
        let found = false;
        for (let i = 0; i < sel.options.length; i++) {
            const opt = sel.options[i];
            // Match by data-name attribute (exact) or text starting with planName
        ...
        // Trigger change event so badge + amount update
        sel.dispatchEvent(new Event('change'));
    }

    // 3. Show badge immediately with correct info (even before change fires)
    showSelectedPlanBadge(planName, price);
    updateAmountDisplay(price);
}
...
function onPlanChange(sel) {
    ...
    if (price > 0 && name) {
        showSelectedPlanBadge(name, price);
        updateAmountDisplay(price);
    } else {
        hidePlanBadge();
    }
...
function showSelectedPlanBadge(name, price) {
...
function hidePlanBadge() {
    const badge = document.getElementById('selectedPlanBadge');
    if (badge) badge.style.display = 'none';
    document.getElementById('amountPreviewWrap').style.display = 'none';
}

function updateAmountDisplay(price) {
    const wrap = document.getElementById('amountPreviewWrap');
...
/* ─── On page load: restore old('plan_id') badge if any ─── */
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (sel && sel.value) {
        ...
        const price = parseFloat(opt.dataset.price || 0);
        const name  = opt.dataset.name || '';
        if (name && price) showSelectedPlanBadge(name, price);
    }
});
</script>
@endpush